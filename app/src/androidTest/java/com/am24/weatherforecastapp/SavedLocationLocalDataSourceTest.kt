...
class SavedLocationLocalDataSourceTest {
    ...
    @Test
    fun location_roundTripsWithoutPrecisionLoss() =
        runBlocking {
            val location =
                SavedLocation(
    ...
    @Test
    fun newerLocation_replacesPreviousLocation() =
        runBlocking {
    ...
    @Test
    fun nullPlaceName_isStoredSafely() =
        runBlocking {
    ...
    @Test
    fun incompleteRecord_returnsNull() =
        runBlocking {
    ...
    @Test
    fun nullName_doesNotOverwriteNameAtSameCoordinates() =
        runBlocking {
